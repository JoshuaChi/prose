...
[Read more about Prose](http://prose.freetofeel.com/#about)
...
Prose is hosted at [prose.freetofeel.com](http://prose.freetofeel.com), or you can use on your own server. For installation instructions and contributing guidelines, please [read contributing.md](CONTRIBUTING.md).
